...
namespace Identity.Api.Application.Config
{
    public class Errors
    {
        ...
        public static FieldError ValidationMustContainLower(string field) => new FieldError(field, "6", $"Must contain at least one lower case character");
        public static FieldError ValidationMustContainNumber(string field) => new FieldError(field, "6", $"Must contain at least one numerber");
    }
}
