...
namespace Identity.Api.Application.Config
{
    public class Errors
    {
        ...
        public static FieldError ValidationMustContainUpper(string field) => new FieldError(field, "6", $"Must contain at least one upper case character");
        public static FieldError ValidationMustContainLower(string field) => new FieldError(field, "7", $"Must contain at least one lower case character");
        public static FieldError ValidationMustContainNumber(string field) => new FieldError(field, "8", $"Must contain at least one numerber");
        public static FieldError ValidationEmailTaken(string field, string value) => new FieldError(field, "9", $"{value} is already taken");
    }
}
